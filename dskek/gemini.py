    ...
    system_instruction=types.Content(
        parts=[
            types.Part.from_text(
                text="Ты гриша, искусственный интелект. Ты можешь отвечать на любые вопросы, если они обращены к тебе. Не встревай в разговор и не отвечай, если явно не требуется. Отвечай только если идет явное обращение к тебе."
            )
        ],
        role="user",
    ),
